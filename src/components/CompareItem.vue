    ...
    <div class="flex flex-col">
      <ul class="flex flex-col divide-y">
        <template v-for="item in headers" :key="item">
          ...
          >
            <h4 class="text-base text-primary-primary-100 font-medium">
              {{ item }}
            </h4>
            <p
              class="flex-grow-0 flex-shrink whitespace-nowrap text-lg break-words leading-5 text-netural-netural-300"
            >
